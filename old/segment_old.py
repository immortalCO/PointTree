...
class Segment(nn.Module):
    def __init__(self, ancestor_dim, encoder, num_parts=0, num_classes=0, force_sample=False):
        super().__init__()
        ...
        if num_parts > 0:
            self.part_classfier = MLP([ancestor_dim, ancestor_dim // 2, ancestor_dim // 4, ancestor_dim // 8, num_parts], last_bn=False)
        else:
